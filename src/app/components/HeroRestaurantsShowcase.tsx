...
const positionStyles = {
  "overlay-top": "absolute -right-16 top-8 w-[280px]",
  "overlay-mid": "absolute -right-28 top-1/2 -translate-y-1/2 w-[300px]",
  "outer-bottom": "absolute -right-12 bottom-6 w-[260px]",
};
  ...
  return (
    <div className="relative w-full flex justify-center lg:mt-0 lg:mb-0">
      <div className="relative mx-auto w-full max-w-[720px] lg:min-h-[560px]">
        <div className="relative rounded-[40px] bg-gradient-to-br from-[#050a14] via-[#070e1d] to-[#02040a] p-4 shadow-[0_50px_120px_rgba(1,4,9,0.85)] ring-1 ring-white/10 w-full lg:mr-12">
