...
export default function DownloadSection() {
  ...
  return (
    <section id="descargar" className="section-gap bg-gradient-to-br from-white via-gray-50/40 to-white relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(244,191,0,0.04),transparent_70%)]" aria-hidden="true" />
      <div className="container-outer max-w-4xl relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-[#052838]/70 leading-relaxed max-w-2xl mx-auto">
            Escanea el código QR con tu cámara para registrarte y recibir acceso prioritario cuando lancemos.
          </p>
        </div>
        <div className="bg-white border border-gray-200 rounded-3xl p-8 md:p-12 shadow-xl">
          <div className="flex flex-col items-center">
            <div className="inline-flex rounded-full p-1 bg-gray-100 border border-gray-200 mb-8" role="group" aria-label="Selecciona plataforma">
              <button
                type="button"
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-[#F4BF00]/10 blur-3xl rounded-full scale-150" aria-hidden="true" />
              <div className="relative bg-white rounded-3xl p-8 shadow-2xl border-2 border-gray-100">
                <Image key={platform} src={qrSrc} alt={qrAlt} width={240} height={240} className="w-[200px] h-[200px] md:w-[240px] md:h-[240px] rounded-xl" />
              </div>
            </div>
            <p className="text-sm text-[#052838]/60 mt-8 mb-6 text-center max-w-md">
              Disponible para iOS y Android. También puedes descargarla desde las tiendas oficiales.
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#052838] text-white rounded-xl hover:bg-[#052838]/90 transition-all hover:scale-105 font-medium text-sm"
              >
